...
export default function ContactSection() {
    ...
    return (
        <section
            ...
            style={{ background: "#FFF1FC", padding: "300px 0 100px", marginTop: "-1px" }}
        >
            <div
                ref={lineImageRef}
            ...
            <div className="relative" style={{ padding: "0 8%", marginLeft: "280px" }}>
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
                    <div className="flex flex-col lg:w-[40%]" style={{ paddingTop: "20px", marginLeft: "-80px" }}>
                        <h2
                            ref={titleRef}
